    ...
    <>
       <div className="w-[95%] mx-auto my-10 space-y-2">
          <div className="w-[95%] m-auto mt-16">
            <h2
              className="text-4xl text-center font-bold leading-[60px] w-full lg:w-[70%] mx-auto"
            >
              What say clients about us.
            </h2>
            <p
              className="text-xs text-[#90A3B4] text-center font-medium leading-[22px] w-[66%] md:w-[60%] lg:w-[40%] mx-auto"
            >
          ...
          <div
            className="w-full mx-auto h-auto lg:h-[800px] bg-none lg:bg-[url('/Images/Clients.png')] flex justify-center items-center"
          >
            <div
              className="w-[420px] flex flex-col justify-center items-center space-y-1 my-4"
            >
              <div className="">
                <img
                  src="/Images/Boy.png"
              ...
              <p
                className="w-[80%] text-xs text-center text-[#90A3B4] font-normal leading-[20px]"
              >
